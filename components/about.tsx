                ...
                <div className="max-w-4xl mx-auto">
                  ...
                  >
                    <div className="text-center">
                      <img draggable={false} src="/maikeru.jpg" alt="Michael Prietl" className="w-40 h-40 rounded-full mx-auto mb-4 border-white border-solid border-4 shadow-lg" />
                    ...
                    <div className="text-center">
                      <img draggable={false} src="/nohell.png" alt="Noel Hermann" className="w-40 h-40 rounded-full mx-auto mb-4 border-white border-solid border-4 shadow-lg" />
                      <h3 className="text-xl font-semibold mb-2 items-center flex justify-center gap-2 hover:underline">
